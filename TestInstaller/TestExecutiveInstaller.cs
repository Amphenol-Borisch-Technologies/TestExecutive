...
namespace TestInstaller {
    ...
    public partial class TestExecutiveInstaller : Installer {
        ...
        // - If TestExecutiveInstaller is compiled as a 64-bit assembly, with the rest of
        //   TestExecutive compiled as 64-bit and the target machine also 64-bit.
        // - Compiling TestExecutiveInstaller as a 32-bit assembly, with the rest of
        //   TestExecutive compiled as 64-bit and the target machine also 64-bit resolves this error.
        ...
        //
        // Unfortunately, compiling TestExecutiveInstaller as a 32-bit assembly causes the following MSBuild Warning:
        ...
        //   and the processor architecture of the reference "C:\Users\phils\source\repos\ABT\Test\TestExecutive\TestLib\bin\x64\TestExecutive\TestLib.dll", "AMD64".
        ...
        public TestExecutiveInstaller() { InitializeComponent(); }
