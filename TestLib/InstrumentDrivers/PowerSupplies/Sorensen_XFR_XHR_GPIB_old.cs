...
namespace ABT.Test.TestExecutive.TestLib.InstrumentDrivers.PowerSupplies {
    public class Sorensen_XFR_XHR_GPIB_old : InstrumentDriver, IPowerSupplyDC_Outputs1 {
        ...
        public Sorensen_XFR_XHR_GPIB_old(String Address, String Detail) : base(Address, Detail, INSTRUMENT_TYPE.POWER_SUPPLY_DC) {
            Command(COMMAND.CLR);
            ResetCommand();
