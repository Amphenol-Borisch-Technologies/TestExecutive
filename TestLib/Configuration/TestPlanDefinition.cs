...
namespace ABT.Test.TestLib.Configuration {
    ...
    public class InstrumentsTestPlan {
        ...
        public List<InstrumentInfo> GetInfo() {
            ...
            InstrumentsTestExec instrumentsTestExec = Serializing.DeserializeFromFile<InstrumentsTestExec>(TestExecDefinitionXML);
        ...
        private String FormatException(String stationaryID) {
            ...
            stringBuilder.AppendLine($"'{TestExecDefinitionXML}'.");
